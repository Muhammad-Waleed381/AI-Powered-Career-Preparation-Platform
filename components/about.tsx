...
export function About() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">03 — PLATFORM</p>
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Why Choose Us</h2>
      </motion.div>
        ...
        <motion.div style={{ x: smoothX }} className="flex gap-16 md:gap-24 px-8 md:px-12 whitespace-nowrap">
          {statements.map((statement, index) => (
            <motion.p
              ...
              style={{
                WebkitTextStroke: index % 2 === 0 ? "none" : "1px hsl(var(--foreground) / 0.3)",
