  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-background">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — EDUCATION</p>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="relative px-8 py-4 border border-border rounded-full font-mono text-sm tracking-widest uppercase bg-transparent backdrop-blur-sm hover:bg-foreground hover:text-background transition-colors duration-500"
          >
            Get Started
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">02 — PLATFORM</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            STUDENTS
            <br />
            <span className="italic">TEACHERS</span>
          </h2>
        </motion.div>
      </motion.div>
