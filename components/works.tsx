  ...
  return (
    <section className="relative py-32 px-8 md:px-12 md:py-24">
      ...
      <motion.div
        ...
        className="mb-24"
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">04 — FEATURES</p>
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Platform Capabilities</h2>
      </motion.div>
